"""Reset migrations with 2FA fields

Revision ID: ddeaab006121
Revises: 
Create Date: 2025-11-05 20:06:40.896756
...
def downgrade():
    ...
    sa.Column('title', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
