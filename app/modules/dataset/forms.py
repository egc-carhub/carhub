...
class FeatureModelForm(FlaskForm):
    car_filename = StringField("CAR Filename", validators=[DataRequired()])
    ...
    version = StringField("CAR Version")
    ...
    def get_fmmetadata(self):
        return {
            "car_filename": self.car_filename.data,
            "title": self.title.data,
            "description": self.desc.data,
            "publication_type": self.publication_type.data,
            "publication_doi": self.publication_doi.data,
            "tags": self.tags.data,
            "car_version": self.version.data,
        }
